...
const s = StyleSheet.create({
  ...
  emptyIcon: { width: 80, height: 80, borderRadius: 40, backgroundColor: PRIMARY + '12', justifyContent: 'center', alignItems: 'center' },
  ...
  cardCurrency: { fontSize: 11, color: '#9ca3af' },
  cardMethod: { fontSize: 12, color: '#6b7280' },
  cardDetail: { fontSize: 11, color: '#9ca3af' },
  cardDate: { fontSize: 10, color: '#d1d5db' },
